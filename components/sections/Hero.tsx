...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-start overflow-hidden bg-[#0E0E10]">
      ...
      {/* Ambient glows */}
      <div className="absolute top-1/3 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[600px] bg-[#C0392B]/8 rounded-full blur-[140px] pointer-events-none z-10" />
      <div className="absolute top-1/2 right-1/4 w-[500px] h-[400px] bg-[#8B1A1A]/6 rounded-full blur-[100px] pointer-events-none z-10" />
        ...
        <div className={`text-start transition-all duration-700 ease-out ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
          ...
          <div className="inline-flex items-center gap-2 bg-[#181820] backdrop-blur-sm border border-white/10 rounded-full px-4 py-1.5 mb-8">
            <span className="relative flex h-1.5 w-1.5">
              <span className="animate-ping absolute h-full w-full rounded-full bg-[#C0392B] opacity-75" />
              <span className="relative rounded-full h-1.5 w-1.5 bg-[#C0392B]" />
            </span>
            <span className="text-[#8C8C9C] text-[11px] font-medium tracking-wider uppercase">NOW STREAMING</span>
          </div>
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-6 leading-[1.05] tracking-tight">
            ...
            <br />
            <span className="text-[#EDE9E0]">IPTV Streaming</span>
          </h1>

          {/* Rating Strip */}
          <div className="flex items-center justify-start gap-3 md:gap-4 mb-6">
            <div className="flex items-center gap-1">
              <span className="text-[#E8A090] text-sm md:text-base" aria-label="Rating">★</span>
              <span className="text-[#EDE9E0] font-semibold text-sm md:text-base">4.9</span>
            </div>
            <div className="w-1 h-1 rounded-full bg-white/20" aria-hidden="true" />
            <span className="text-[#8C8C9C] text-sm md:text-base">Movies</span>
            <div className="w-1 h-1 rounded-full bg-white/20" aria-hidden="true" />
            <span className="text-[#8C8C9C] text-sm md:text-base">Sports</span>
            <div className="w-1 h-1 rounded-full bg-white/20" aria-hidden="true" />
            <span className="text-[#8C8C9C] text-sm md:text-base">4K</span>
          </div>

          {/* Description */}
          <p className="text-[#8C8C9C] text-base md:text-lg max-w-2xl mb-10 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-start mb-12">
            <button
              ...
              className="group px-8 py-3.5 bg-[#C0392B] text-white rounded-full font-semibold text-base transition-all duration-300 shadow-lg shadow-[#C0392B]/30 hover:bg-[#E8A090] hover:shadow-[#C0392B]/50 hover:scale-[1.03] cursor-pointer"
            >
              Start Watching
            </button>
            <a
              href="#content"
              className="px-8 py-3.5 bg-transparent backdrop-blur-sm border border-[#8C8C9C] hover:border-[#C0392B] text-[#8C8C9C] hover:text-[#E8A090] rounded-full font-semibold text-base transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_4px_20px_rgba(192,57,43,0.2)] text-center"
            >
              Watch Trailer
            </a>
          </div>
          ...
          <div className="flex flex-wrap gap-4 md:gap-6 justify-start">
            {[
              ...
              <div key={feat.label} className="flex items-center gap-2">
                ...
                <span className="text-[#8C8C9C] text-sm">{feat.label}</span>
              </div>
            ))}
          </div>
        </div>
