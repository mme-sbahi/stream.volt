...
export default function ContentPreview() {
  ...
  return (
    <section
      id="content"
      className="py-16 md:py-24 relative overflow-hidden bg-[#0E0E10]"
    >
      <div
        className="absolute left-0 top-0 bottom-0 w-24 pointer-events-none z-10"
        style={{ background: "linear-gradient(90deg, #0E0E10, transparent)" }}
      />
      <div
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#C0392B]/5 rounded-full blur-[100px] pointer-events-none" />

      <div ref={ref} className="relative z-0 max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-12 reveal">
          <span className="inline-block text-xs font-bold tracking-[0.25em] uppercase text-[#C0392B] mb-4 px-3 py-1 rounded-full border border-[#C0392B]/30 bg-[#C0392B]/10 animate-pulse">
            Content Library
          </span>
              ...
              <div className="flex items-center justify-between mb-4 px-2">
                <div className="flex items-center gap-2">
                  ...
                  <div className="hidden md:flex gap-1 ml-2">
                    ...
                    <div className="w-1 h-1 rounded-full bg-[#E8A090]"></div>
                    <div className="w-1 h-1 rounded-full bg-[#8C8C9C]"></div>
                  </div>
                </div>
                <button
                  onClick={scrollToPricing}
                  className="text-[#8C8C9C] hover:text-[#E8A090] text-xs uppercase tracking-wider transition-all duration-300 flex items-center gap-1 group"
                >
                  View All
        ...
        <div className="text-center mt-16 px-6 reveal flex flex-col">
          <div className="relative inline-block">
            <div className="absolute inset-0 bg-gradient-to-r from-[#C0392B]/20 to-[#E8A090]/20 rounded-2xl blur-xl" />
            <p className="relative text-[#8C8C9C] text-sm mb-4">
          ...
          <div className="flex justify-center">
            <button
              onClick={scrollToPricing}
              type="button"
              className="group relative inline-flex items-center gap-2 px-8 py-3.5 bg-[#C0392B] text-white rounded-xl font-semibold transition-all duration-300 hover:bg-[#E8A090] hover:scale-105 hover:shadow-2xl hover:shadow-[#C0392B]/30 overflow-hidden cursor-pointer"
            >
  ...
  return (
    ...
    >
      <div className="relative rounded-xl overflow-hidden aspect-[2/3] shadow-lg bg-gradient-to-br from-gray-900 to-black">
        ...
        {(!posterUrl || imageError) && (
          <div className="absolute inset-0 bg-gradient-to-br from-[#8B1A1A]/40 to-[#C0392B]/40 flex flex-col items-center justify-center p-4">
        ...
        <div className="absolute top-2 right-2 bg-black/70 backdrop-blur-sm rounded-full px-1.5 py-0.5 z-10">
          <span className="text-[9px] text-amber-400">★ {rating}</span>
        </div>
        ...
        <div className="absolute bottom-2 left-2 right-2 z-10">
          <div className="bg-[#181820]/90 backdrop-blur-sm rounded-lg px-2 py-1 text-center border border-white/10">
            <span className="text-[9px] md:text-[10px] text-[#E8A090] font-medium">
              {quality}
            </span>
          </div>
        </div>
        ...
        >
          <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#C0392B]/80 backdrop-blur-md flex items-center justify-center text-xl md:text-2xl border border-white/30 transform scale-100 hover:scale-110 transition-transform">
            ▶
          </div>
